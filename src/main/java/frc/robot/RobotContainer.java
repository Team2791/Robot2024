...
public class RobotContainer {
	...
	final CommandXboxController driverctl =
			new CommandXboxController(IOConstants.Controller.kDriverPort);
	final CommandXboxController operctl =
			new CommandXboxController(IOConstants.Controller.kOperatorPort);
	...
	private void bindings() {
		...
		// Climber
		driverctl.povUp()
				.whileTrue(new ManualClimb(climber, 0, true, ClimberConstants.Speeds.kClimb));
		driverctl.povDown()
				.whileTrue(new ManualClimb(climber, 0, false, ClimberConstants.Speeds.kClimb));
		driverctl.povRight()
				.whileTrue(new ManualClimb(climber, 2, true, ClimberConstants.Speeds.kClimb));
		driverctl.povLeft()
				.whileTrue(new ManualClimb(climber, 2, false, ClimberConstants.Speeds.kClimb));
