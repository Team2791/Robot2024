...
public class TwoCube extends SequentialCommandGroup {
	/** Creates a new SimpleForwardBack. */
	public TwoCube() {
		...
		addCommands(
				...
				new ParallelCommandGroup(new SequentialCommandGroup(new ExtendArm(6), new PivotArm(20)),
						new AutoDrive(-4.6)),
				...
				new ParallelCommandGroup(new PivotArm(-55), new AutoDrive(4)),
