...
public class AutoPhotonAimCube extends CommandBase {
	...
	public AutoPhotonAimCube(PhotonCamera c, PhotonCamera c2, double setpoint, boolean tag) {
	...
	public boolean isFinished() {
		...
		return pid.atSetpoint() || timer.get() > 0.8;
	}
}
