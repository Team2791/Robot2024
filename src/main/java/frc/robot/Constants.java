...
public final class Constants {
    ...
    public static final class ModuleConstants {
        ...
        public static final double kDrivingMotorReduction =
                (45.0 * 20) / (kDrivingMotorPinionTeeth * 15.0);
        public static final double kDriveWheelFreeSpeedRps =
                (kDrivingMotorFreeSpeedRps * kWheelCircumferenceMeters) / kDrivingMotorReduction;
        public static final double kDrivingFF = 1 / kDriveWheelFreeSpeedRps; //0
        ...
        public static final double kDrivingP = 0.15; // .6
        public static final double kDrivingI = 0;
        public static final double kDrivingD = 0.01; //.03
        public static final double kDrivingMinOutput = -1;
        public static final double kDrivingMaxOutput = 1;

        public static final double kTurningP = 0.3; // .04
    ...
    public static final class ArmConstants {
        public static final double AmpPivot = 100;
        public static final double AmpExt = 100;
        ...
        public static final double kArmPivotIntakePos = 7; //intake setpoint


        public static final double EncoderMin = -3.54; //3593
        public static final double EncoderMax = 29.8;

        public static final double AngleMax = 90.0;
        public static final double AngleMin = -11;//-10.4;
